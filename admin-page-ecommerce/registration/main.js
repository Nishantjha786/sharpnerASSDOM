...
//creating person object
    const person = {
        product name: userName.value,
        product price : userEmail.value ,
        // userPhone : userPhone.value,
        cateogory : userDate.value

    }
    console.log(JSON.stringify(person));

//add to server 
await axios.post(`https://crudcrud.com/api/26d0bc4798cc48f583a17e12350c600d/sample`, { person })
  .then((res) => {
  ...
  axios.get(`https://crudcrud.com/api/26d0bc4798cc48f583a17e12350c600d/sample`)
  .then((res) => { 
...
//get from server 
axios
.get(`https://crudcrud.com/api/26d0bc4798cc48f583a17e12350c600d/sample/${btnId}`)
.then(res=>{
    editing(res);
    console.log(res);
...
//delete from server 
axios
.delete(`https://crudcrud.com/api/26d0bc4798cc48f583a17e12350c600d/sample/${btnId}`)
...
axios
.get(`https://crudcrud.com/api/26d0bc4798cc48f583a17e12350c600d/sample`)
.then((res) => { 
